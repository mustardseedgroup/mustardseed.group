---
title: 'September 2018: Small products, compounding learning'
slug: 2018-09-small-products-compounding-learning
date: '2018-09-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on small products as learning machines.
category: Product
...
This month, the focus is small products as learning machines. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for September 2018 is simple: what can be learned from small products as learning machines, and what should be kept small until the signal is stronger?
