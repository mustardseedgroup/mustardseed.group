...
Orion is the AI intelligence layer inside Orbit. It is also an ongoing research project sitting inside Benediction Lab. These two facts are not in tension — they are the same fact described from different vantage points.
