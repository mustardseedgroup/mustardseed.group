---
title: 'August 2021: Creative tooling and distribution'
slug: 2021-08-creative-tooling-and-distribution
date: '2021-08-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on tools for creative output and distribution.
category: Culture
...
This month, the focus is tools for creative output and distribution. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for August 2021 is whether tools for creative output and distribution can become more than an observation: a repeatable method, a product surface or a clearer way to operate.
