---
title: 'October 2016: The value of constraints'
slug: 2016-10-the-value-of-constraints
date: '2016-10-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on constraint as a design tool.
...
This month, the focus is constraint as a design tool. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for October 2016 is simple: what can be learned from constraint as a design tool, and what should be kept small until the signal is stronger?
