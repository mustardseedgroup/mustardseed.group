---
title: 'August 2016: From projects to methods'
...
published: true
summary: >-
  A historical MSG archive draft on turning one-off work into repeatable
  practice.
...
This month, the focus is turning one-off work into repeatable practice. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for August 2016 is simple: what can be learned from turning one-off work into repeatable practice, and what should be kept small until the signal is stronger?
