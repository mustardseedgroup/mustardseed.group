...
reviewed: true
published: true
summary: A historical MSG archive draft on year-end notes on tools and taste.
...
This month, the focus is year-end notes on tools and taste. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for December 2018 is simple: what can be learned from year-end notes on tools and taste, and what should be kept small until the signal is stronger?
