---
title: 'September 2017: The role of memory'
slug: 2017-09-the-role-of-memory
date: '2017-09-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on why useful systems need continuity.
category: Research
...
This month, the focus is why useful systems need continuity. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for September 2017 is simple: what can be learned from why useful systems need continuity, and what should be kept small until the signal is stronger?
