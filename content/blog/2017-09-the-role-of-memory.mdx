...
These three properties — continuity, accessibility, relevance — are difficult to achieve simultaneously. Achieving one tends to compromise the others. Continuity creates large, rich records that are slow to retrieve. Fast retrieval systems tend to flatten context, sacrificing continuity for speed. Relevance filtering is hard because relevance changes depending on who is asking and why.
...
These are not AI questions in the narrow sense of the term. They are questions about how systems relate to time, to history, and to the humans working through them.
...
The answer is systems that remember with continuity, that surface context when it becomes relevant, and that understand the difference between what a person needs to know and what merely exists on record.
