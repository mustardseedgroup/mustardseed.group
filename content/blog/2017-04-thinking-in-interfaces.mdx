---
title: 'April 2017: Thinking in interfaces'
...
published: true
summary: >-
  A historical MSG archive draft on interfaces as the place where systems become
  usable.
category: Product
...
This month, the focus is interfaces as the place where systems become usable. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for April 2017 is simple: what can be learned from interfaces as the place where systems become usable, and what should be kept small until the signal is stronger?
