---
title: 'March 2018: Organising ideas into systems'
slug: 2018-03-organising-ideas-into-systems
date: '2018-03-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on turning ideas into durable structures.
...
This month, the focus is turning ideas into durable structures. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for March 2018 is simple: what can be learned from turning ideas into durable structures, and what should be kept small until the signal is stronger?
