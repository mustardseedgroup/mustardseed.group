---
title: 'July 2016: Personal operating systems'
slug: 2016-07-personal-operating-systems
date: '2016-07-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on personal systems before software systems.
...
This month, the focus is personal systems before software systems. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for July 2016 is simple: what can be learned from personal systems before software systems, and what should be kept small until the signal is stronger?
