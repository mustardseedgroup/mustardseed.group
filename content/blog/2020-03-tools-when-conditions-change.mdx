---
title: 'March 2020: Tools when conditions change'
slug: 2020-03-tools-when-conditions-change
date: '2020-03-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on tools as resilience during change.
category: Product
...
This month, the focus is tools as resilience during change. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for March 2020 is whether tools as resilience during change can become more than an observation: a repeatable method, a product surface or a clearer way to operate.
