...
In February 2023, Meta released the weights for Llama 1. It was not the most capable model available — it was not designed to be. What it did was collapse the cost of entry for serious local experimentation. For the first time, a research-grade language model could run on hardware that people actually owned.
