---
title: 'January 2015: The seed idea'
slug: 2015-01-the-seed-idea
date: '2015-01-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on small systems and long-term capability.
...
This month, the focus is small systems and long-term capability. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for January 2015 is simple: what can be learned from small systems and long-term capability, and what should be kept small until the signal is stronger?
