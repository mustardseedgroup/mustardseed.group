---
title: 'October 2018: The first group thesis'
slug: 2018-10-the-first-group-thesis
date: '2018-10-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on the earliest shape of a wider group thesis.
category: Founder letter
project: Mustard Seed Group
thumbnail: /images/updates/2018-10-the-first-group-thesis.svg
source_links:
...
This month, the focus is the earliest shape of a wider group thesis. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for October 2018 is simple: what can be learned from the earliest shape of a wider group thesis, and what should be kept small until the signal is stronger?
