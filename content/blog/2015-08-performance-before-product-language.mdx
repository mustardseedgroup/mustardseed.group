---
title: 'August 2015: Performance before product language'
...
published: true
summary: >-
  A historical MSG archive draft on human performance before it becomes
  software.
...
This month, the focus is human performance before it becomes software. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for August 2015 is simple: what can be learned from human performance before it becomes software, and what should be kept small until the signal is stronger?
