...
thumbnail: /images/updates/2023-12-the-portfolio-becomes-coherent.svg
source_links:
...
It is also worth noting what kind of year 2023 has been for the broader field. The GPT-4 release in March, the proliferation of tooling around large language models, and the first serious mainstream conversation about agents: these have not been distractions. They have been a clarifying pressure. When the world suddenly has opinions about what AI can and cannot do, it forces a more precise account of what the actual thesis is and how the actual work differs from the noise. The pressure has been useful.
...
What 2023 has tested in particular is the assumption that general-purpose AI interfaces are sufficient for commercial work. The year demonstrated fairly clearly that they are not: the gap between a capable language model and a useful commercial operating system is a design and integration problem, not a capability problem. Orbit is oriented towards closing that gap from the product side. Orion is oriented towards closing it from the intelligence side.
...
There is also something useful about maintaining a services function during a period when the AI tooling landscape is changing as fast as it has been. What clients ask for, and what they actually need once the work is underway, are often different things. The gap between those two is data. Accumulating it deliberately is one of the less celebrated but more important things TUXX does.
...
The agent conversation has picked up considerably in the latter half of 2023, and the framing in most public discourse is still fairly shallow: agents as task-completion mechanisms, as glorified automation scripts. The research questions that matter for the actual use of agents in commercial and consumer settings are harder: how do agents maintain useful context over time, how do they fail gracefully, how do they know what they do not know. These are the questions that determine whether agents become genuinely useful tools or remain impressive demonstrations. Benediction Lab is working in that harder territory.
...
It is worth saying plainly: the consumer work is not a side project or a diversification hedge. The questions it is working on, what does a meaningful AI relationship with a person look like over months and years, what does accountability feel like when it is genuinely personalised, are directly relevant to the long-term Orion research. The contexts differ but the underlying problem is the same.
