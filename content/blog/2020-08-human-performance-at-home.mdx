---
title: 'August 2020: Human performance at home'
...
published: true
summary: >-
  A historical MSG archive draft on performance systems outside formal
  environments.
...
This month, the focus is performance systems outside formal environments. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for August 2020 is whether performance systems outside formal environments can become more than an observation: a repeatable method, a product surface or a clearer way to operate.
