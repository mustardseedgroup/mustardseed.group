---
title: 'May 2019: Human performance as a technology problem'
slug: 2019-05-human-performance-as-a-technology-problem
date: '2019-05-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on performance as a system to design.
...
This month, the focus is performance as a system to design. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for May 2019 is whether performance as a system to design can become more than an observation: a repeatable method, a product surface or a clearer way to operate.
