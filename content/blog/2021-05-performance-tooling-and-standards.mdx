---
title: 'May 2021: Performance tooling and standards'
...
published: true
summary: >-
  A historical MSG archive draft on standards as a tool for personal
  performance.
...
This month, the focus is standards as a tool for personal performance. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for May 2021 is whether standards as a tool for personal performance can become more than an observation: a repeatable method, a product surface or a clearer way to operate.
