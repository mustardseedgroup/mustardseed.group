...
This is one of the genuine tensions in building consumer performance products. The interface choices that make short-term retention metrics look strong — streaks, guilt mechanics, daily notifications, comparative leaderboards — are often directly hostile to the long-term performance outcomes that would make the product genuinely worth keeping. What maximises day-seven engagement is not always what increases the probability of someone showing up eighteen months from now and crediting the product with having helped them build something real.
