...
Repeated friction is a signal. It tells you where teams lose momentum, where standards quietly collapse, and where a better system would change the outcome at scale. It is not glamorous intelligence, but it is diagnostic. And it is honest, and honest diagnoses make better products than optimistic ones.
