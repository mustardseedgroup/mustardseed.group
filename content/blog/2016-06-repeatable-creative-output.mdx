---
title: 'June 2016: Repeatable creative output'
slug: 2016-06-repeatable-creative-output
date: '2016-06-15'
status: published
reviewed: true
published: true
summary: 'A historical MSG archive draft on creative output as a system, not a mood.'
category: Culture
...
This month, the focus is creative output as a system, not a mood. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for June 2016 is simple: what can be learned from creative output as a system, not a mood, and what should be kept small until the signal is stronger?
