---
title: 'September 2020: Content, media and distribution'
slug: 2020-09-content-media-and-distribution
date: '2020-09-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on distribution as part of creative systems.
category: Culture
...
This month, the focus is distribution as part of creative systems. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for September 2020 is whether distribution as part of creative systems can become more than an observation: a repeatable method, a product surface or a clearer way to operate.
