...
It is mostly wrong. Or rather, it confuses cause and effect. The organisations that compound over time are not the ones that hired more people — they are the ones that built better operating systems and then grew. The sequence matters. If you hire into disorder, you get larger disorder. You also get a payroll.
