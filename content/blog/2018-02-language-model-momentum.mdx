---
title: 'February 2018: Language model momentum'
slug: 2018-02-language-model-momentum
date: '2018-02-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on early momentum around language models.
category: Research
...
This month, the focus is early momentum around language models. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for February 2018 is simple: what can be learned from early momentum around language models, and what should be kept small until the signal is stronger?
