---
title: 'July 2021: Consumer products as behaviour systems'
slug: 2021-07-consumer-products-as-behaviour-systems
date: '2021-07-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on consumer products shaping behaviour.
...
This month, the focus is consumer products shaping behaviour. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for July 2021 is whether consumer products shaping behaviour can become more than an observation: a repeatable method, a product surface or a clearer way to operate.
