...
The category question — is this a CRM, a project tool, an ERP, something else? — comes up repeatedly. The honest answer is that none of the existing categories fully describe it. Orbit is being designed as an operating surface for the full lead-to-launched-product flow. The language matters: not a database, not a board, not a suite — a surface. Something you work on, not simply a place where records accumulate.
