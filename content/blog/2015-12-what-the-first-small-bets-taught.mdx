---
title: 'December 2015: What the first small bets taught'
...
published: true
summary: >-
  A historical MSG archive draft on the end-of-year lesson from early
  experiments.
...
This month, the focus is the end-of-year lesson from early experiments. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for December 2015 is simple: what can be learned from the end-of-year lesson from early experiments, and what should be kept small until the signal is stronger?
