---
title: 'November 2025: Content as institutional memory'
slug: 2025-11-content-as-institutional-memory
date: '2025-11-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on updates as institutional memory.
...
This month, the focus is updates as institutional memory. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for November 2025 is what updates as institutional memory strengthens in the wider ecosystem, and what should remain protected while the public surface becomes clearer.
