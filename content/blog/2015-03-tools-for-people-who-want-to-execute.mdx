...
published: true
summary: >-
  A historical MSG archive draft on the early need for tools that help people
  move.
...
This month, the focus is the early need for tools that help people move. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for March 2015 is simple: what can be learned from the early need for tools that help people move, and what should be kept small until the signal is stronger?
