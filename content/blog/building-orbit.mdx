...
Orbit is a product for teams doing serious commercial work. Not for massive enterprise sales organisations with dedicated operations functions — those teams have resources to build internal systems. Not for freelancers working alone — the coordination problem doesn't arise at that scale.
