---
title: 'October 2015: Systems for consistency'
slug: 2015-10-systems-for-consistency
date: '2015-10-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on consistency as a designed environment.
...
This month, the focus is consistency as a designed environment. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for October 2015 is simple: what can be learned from consistency as a designed environment, and what should be kept small until the signal is stronger?
