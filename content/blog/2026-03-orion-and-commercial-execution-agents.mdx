...
Decisions with significant consequences, such as entering a project, committing to a scope, or making a representation to a client about what can be delivered, require a human to own them. The agent can surface relevant information, flag risks based on pattern recognition, and ensure the decision-maker has what they need. It should not make those calls.
