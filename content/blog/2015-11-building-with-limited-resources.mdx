...
reviewed: true
published: true
summary: A historical MSG archive draft on constraint as a useful forcing function.
...
This month, the focus is constraint as a useful forcing function. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for November 2015 is simple: what can be learned from constraint as a useful forcing function, and what should be kept small until the signal is stronger?
