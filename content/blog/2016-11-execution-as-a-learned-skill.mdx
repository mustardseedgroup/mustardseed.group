---
title: 'November 2016: Execution as a learned skill'
slug: 2016-11-execution-as-a-learned-skill
date: '2016-11-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on execution as trained behaviour.
category: Performance
project: Mustard Seed Group
thumbnail: /images/updates/2016-11-execution-as-a-learned-skill.svg
source_links:
...
This month, the focus is execution as trained behaviour. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for November 2016 is simple: what can be learned from execution as trained behaviour, and what should be kept small until the signal is stronger?
