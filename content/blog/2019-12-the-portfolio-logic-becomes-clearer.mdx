...
reviewed: true
published: true
summary: A historical MSG archive draft on year-end note on portfolio logic.
...
This month, the focus is year-end note on portfolio logic. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for December 2019 is whether year-end note on portfolio logic can become more than an observation: a repeatable method, a product surface or a clearer way to operate.
