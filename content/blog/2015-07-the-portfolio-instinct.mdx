---
title: 'July 2015: The portfolio instinct'
...
published: true
summary: >-
  A historical MSG archive draft on the beginning of a multi-domain portfolio
  mindset.
...
This month, the focus is the beginning of a multi-domain portfolio mindset. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for July 2015 is simple: what can be learned from the beginning of a multi-domain portfolio mindset, and what should be kept small until the signal is stronger?
