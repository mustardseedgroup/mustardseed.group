---
title: 'May 2016: Habits as infrastructure'
...
published: true
summary: >-
  A historical MSG archive draft on habit systems as infrastructure for personal
  capability.
...
This month, the focus is habit systems as infrastructure for personal capability. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for May 2016 is simple: what can be learned from habit systems as infrastructure for personal capability, and what should be kept small until the signal is stronger?
