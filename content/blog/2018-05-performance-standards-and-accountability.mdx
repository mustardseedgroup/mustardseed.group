---
title: 'May 2018: Performance standards and accountability'
slug: 2018-05-performance-standards-and-accountability
date: '2018-05-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on standards as a performance interface.
...
This month, the focus is standards as a performance interface. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for May 2018 is simple: what can be learned from standards as a performance interface, and what should be kept small until the signal is stronger?
