---
title: 'January 2020: Operating through uncertainty'
slug: 2020-01-operating-through-uncertainty
date: '2020-01-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on systems that hold up under uncertainty.
...
This month, the focus is systems that hold up under uncertainty. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for January 2020 is whether systems that hold up under uncertainty can become more than an observation: a repeatable method, a product surface or a clearer way to operate.
