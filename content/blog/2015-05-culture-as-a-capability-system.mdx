---
title: 'May 2015: Culture as a capability system'
slug: 2015-05-culture-as-a-capability-system
date: '2015-05-15'
status: published
reviewed: true
published: true
summary: 'A historical MSG archive draft on music, media and creative output as systems.'
category: Culture
...
This month, the focus is music, media and creative output as systems. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for May 2015 is simple: what can be learned from music, media and creative output as systems, and what should be kept small until the signal is stronger?
