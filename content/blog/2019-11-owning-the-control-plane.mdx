---
title: 'November 2019: Owning the control plane'
slug: 2019-11-owning-the-control-plane
date: '2019-11-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on owning the interface where work is directed.
...
This month, the focus is owning the interface where work is directed. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for November 2019 is whether owning the interface where work is directed can become more than an observation: a repeatable method, a product surface or a clearer way to operate.
