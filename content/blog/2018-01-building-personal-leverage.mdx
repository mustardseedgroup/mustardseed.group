---
title: 'January 2018: Building personal leverage'
slug: 2018-01-building-personal-leverage
date: '2018-01-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on small systems that create leverage.
category: Founder letter
project: Mustard Seed Group
thumbnail: /images/updates/2018-01-building-personal-leverage.svg
source_links:
...
This month, the focus is small systems that create leverage. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for January 2018 is simple: what can be learned from small systems that create leverage, and what should be kept small until the signal is stronger?
