---
title: 'June 2019: Accountability as product thinking'
slug: 2019-06-accountability-as-product-thinking
date: '2019-06-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on accountability as a product surface.
...
This month, the focus is accountability as a product surface. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for June 2019 is whether accountability as a product surface can become more than an observation: a repeatable method, a product surface or a clearer way to operate.
