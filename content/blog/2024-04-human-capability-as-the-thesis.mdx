---
title: 'April 2024: Human capability as the thesis'
slug: 2024-04-human-capability-as-the-thesis
date: '2024-04-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on human capability as the group-level thesis.
...
This month, the focus is human capability as the group-level thesis. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for April 2024 is what human capability as the group-level thesis strengthens in the wider ecosystem, and what should remain protected while the public surface becomes clearer.
