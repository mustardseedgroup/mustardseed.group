---
title: 'January 2016: Capability as the shared thesis'
slug: 2016-01-capability-as-the-shared-thesis
date: '2016-01-15'
status: published
reviewed: true
published: true
summary: A historical MSG archive draft on capability as the common thread.
...
This month, the focus is capability as the common thread. The point is not to pretend the answer is finished. It is to record the direction of travel while the work is still forming.
...
The question for January 2016 is simple: what can be learned from capability as the common thread, and what should be kept small until the signal is stronger?
